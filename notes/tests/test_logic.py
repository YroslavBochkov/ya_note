...
class CheckData(CoreTestCase):
    def check_data(self, field_data):
        """Тест данных заметки в БД с данными из формы."""
...
class TestCreateNote(CheckData):
    ...
    def test_user_can_create_note(self):
        ...
        self.equal(expected_count)
        self.check_data(self.field_data)
...
class TestNoteEditDelete(CheckData, CoreTestCase):
    @classmethod
    def setUpTestData(cls):
        super().setUpTestData()
    ...
    def test_author_can_edit_note(self):
        ...
        self.check_data((*FIELD_NEW_DATA, self.author))
    ...
    def test_other_user_cant_edit_note(self):
        ...
        self.check_data((*FIELD_DATA, self.author))
